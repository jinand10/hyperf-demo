...
return [
    'default' => [
        ...
        'pool' => [
            ...
            'max_connections' => (int) env('REDIS_MIN_CONNECTIONS', 10),
    ...
    'cache' => [
        ...
        'pool' => [
            'min_connections' => (int) env('CACHE_REDIS_MIN_CONNECTIONS', 1),
            'max_connections' => (int) env('CACHE_REDIS_MIN_CONNECTIONS', 10),
            'connect_timeout' => 10.0,
            'wait_timeout' => 3.0,
            'heartbeat' => -1,
    ...
    'async_queue' => [
        ...
        'pool' => [
            ...
            'max_connections' => (int) env('QUEUE_REDIS_MIN_CONNECTIONS', 10),
            'connect_timeout' => 10.0,
            'wait_timeout' => 3.0,
            'heartbeat' => -1,
